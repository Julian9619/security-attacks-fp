...
namespace gazebo
{
    class SensorExample : public SensorPlugin
    {
        public:SensorExample() : SensorPlugin(){
        ...
        */
        ...
        void Load(sensors::SensorPtr _sensor, sdf::ElementPtr _sdf)
        {
            ...
            {
                gzerr << "SensorExample requires a ContactSensor.\n";
                return;
            }

            this->updateConnection = this->parentSensor->ConnectUpdated(
              std::bind(&SensorExample::OnUpdate, this));
            ...
            ros::SubscribeOptions so = ros::SubscribeOptions::create<std_msgs::Int8MultiArray>(
                ...
                boost::bind(&SensorExample::OnRosMsg, this, _1), 
                ros::VoidPtr(),&rosQueue);

            rosSub = rosNode->subscribe(so);
            rosQueueThread =std::thread(std::bind(&SensorExample::QueueThread, this));
    ...
    GZ_REGISTER_SENSOR_PLUGIN(SensorExample)
}
